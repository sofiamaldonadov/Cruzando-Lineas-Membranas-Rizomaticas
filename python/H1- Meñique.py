# You can toggle this based on your tracking assignment
IS_RIGHT_HAND = True

DETECTION_THRESHOLD = 0.010
MAX_THUMB_DISTANCE = 0.1
...
def onValueChange(channel, sampleIndex, val, prev):
    ...
    # Adjust thumb direction check based on left/right hand
    if IS_RIGHT_HAND:
        thumb_distance = thumb_tip_x - thumb_ip_x  # Right thumb folds toward higher X
    else:
        thumb_distance = thumb_ip_x - thumb_tip_x  # Left thumb folds toward lower X
